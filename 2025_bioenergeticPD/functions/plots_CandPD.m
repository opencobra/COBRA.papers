function plots_CandPD(demandATP,f,d)
    ...
    if any(contains(models,'PD'))
        ...
        for k=1:length(fieldnames(type))
            ...
            Pathways={'oxidative phosphorylation (ATPS4mi)', 'glycolysis (PGK & PYK)', ...
                ...
                'nucleotide interconversion (NDPK1-10 & UMPK & URIDK3 & ADK1 & r0345)', 'NAD metabolism (NMNATr)',...
            ...
            ydata = [cell2mat(model1.ATPS4mi(:,1)), cell2mat(model1.glycolysis(:,1)), (cell2mat(model1.r0408(:,1)) ...
                ...
                cell2mat(model1.r0345(:,1)) + cell2mat(model1.ADK1(:,1))),...
            ...
            ydataPD= [cell2mat(model2.ATPS4mi(:,1)), cell2mat(model2.glycolysis(:,1)), (cell2mat(model2.r0408(:,1)) ...
                ...
                (cell2mat(model2.UMPK(:,1)) + cell2mat(model2.URIDK3(:,1)) + ...
                cell2mat(model2.NDPK1(:,1)) + cell2mat(model2.NDPK2(:,1))+ ...
                cell2mat(model2.NDPK3(:,1)) + cell2mat(model2.NDPK4(:,1))+ ...
                cell2mat(model2.NDPK5(:,1)) + cell2mat(model2.NDPK6(:,1))+ ...
                cell2mat(model2.NDPK7(:,1)) + cell2mat(model2.NDPK8(:,1)) + ...
                cell2mat(model2.NDPK9(:,1)) + cell2mat(model2.NDPK10(:,1)) + ...
                cell2mat(model2.r0345(:,1)) + cell2mat(model2.ADK1(:,1))),...
            ...
            if f=='barchart'
                ...
                for j = 1:col
                    ...
                    if j==7
                        xlabel({'Energy demand (ATPM,umol/gDW/h)'},'Position', [335 -4.5 0],'FontSize',20)
                        figure1 = f2;
                        annotate
                    end
                    % add annotation
