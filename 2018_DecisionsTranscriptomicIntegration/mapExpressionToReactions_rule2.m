function [expressionRxns, parsedGPR, gene_used] = mapExpressionToReactions_rule2(model, expressionData)                                          
% Determines the expression data associated to each reaction present in
% the model based on the mapping AND=min and OR=SUM
%
% USAGE:
...
[expressionRxns, gene_used] = selectGeneFromGPR_rule2(model, gene_id, gene_expr, parsedGPR);